...
public class MainUIController extends BaseFXController {
	...
	@FXML
	private CheckBox orderByClauseCheckBox;
...
//			System.out.println(tableList2.size());
	...
	public GeneratorConfig getGeneratorConfigFromUI() {
		...
		generatorConfig.setOrderByClause(orderByClauseCheckBox.isSelected());
	...
	public void setGeneratorConfigIntoUI(GeneratorConfig generatorConfig) {
		...
		orderByClauseCheckBox.setSelected(generatorConfig.isOrderByClause());
