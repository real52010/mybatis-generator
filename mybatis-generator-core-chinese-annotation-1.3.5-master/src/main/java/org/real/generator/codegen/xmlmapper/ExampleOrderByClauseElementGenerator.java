 ...
 *
 */
public class ExampleOrderByClauseElementGenerator extends AbstractXmlElementGenerator {

	private boolean isForUpdateByExample;

	public ExampleOrderByClauseElementGenerator(boolean isForUpdateByExample) {
		super();
	...
	public void addElements(XmlElement parentElement) {
		...
		answer.addAttribute(new Attribute("id", "Example_OrderBy_Clause")); //$NON-NLS-1$
		// } else {
