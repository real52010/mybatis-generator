 ...
 *
 */
public class VirtualDeleteByPrimaryKeyElementGenerator extends
        AbstractXmlElementGenerator {

    private boolean isSimple;

    public VirtualDeleteByPrimaryKeyElementGenerator(boolean isSimple) {
        super();
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute(
                "id", "virtualDeleteByPrimaryKey")); //$NON-NLS-1$
