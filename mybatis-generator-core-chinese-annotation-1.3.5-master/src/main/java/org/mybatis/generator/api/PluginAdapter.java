...
public abstract class PluginAdapter implements Plugin {
	...
	/**
	 * 生成基础实体类 在MBG生成record类的时候调用的插件的方法，在该方法中，传入两个参数
	 *
	 * @param topLevelClass
	 *            该类的实例就是表示当前正在生成的类的DOM结构
	 * @param introspectedTable
	 *            代表的runtime环境，包含了所有context中的配置，一般从这个类中去查询生成对象的一些规则；
	 * @return
	 */
	...
	/**
	 * 生成带BLOB字段的对象 在MBG生成key Class类的时候调用的插件的方法
	 * 
	 * @param topLevelClass
...
//	@Override
//	public boolean baseElementGenerated(XmlElement parentElement, IntrospectedTable introspectedTable) {
//		// TODO Auto-generated method stub
//		return true;
//	}
//	@Override
//	public boolean exampleElementGenerated(XmlElement parentElement, IntrospectedTable introspectedTable) {
//		// TODO Auto-generated method stub
//		return true;
//	}
